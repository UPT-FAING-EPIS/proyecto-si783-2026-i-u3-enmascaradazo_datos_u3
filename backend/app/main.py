...
from app.api.routers import connections, rules, jobs, reports, workbench
...
def api_meta():
    ...
    return {
        ...
        "api_prefix": settings.API_V1_STR,
        "has_register": True,
        "supported_databases": ["postgres", "mysql", "mariadb", "sqlite", "sqlserver", "oracle", "cassandra", "mongodb", "redis", "neo4j"],
        "masking_modes": ["dry_run", "apply", "virtual_query"],
    }
