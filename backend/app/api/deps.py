...
from app.infrastructure.repositories.vault_repo import MongoVaultRepository, file_vault_repository
...
async def get_workbench_service(
    ...
    return WorkbenchService(repository)
